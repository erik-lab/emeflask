...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'docTagger.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/docTagger.html'`` the file from the app1 package is loaded,
    by loading ``'app2/docTagger.html'`` the file from the second.
    """
